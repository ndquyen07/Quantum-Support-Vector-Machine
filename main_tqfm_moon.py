...
# Load data
loaded_data = np.load('data/moon_data.npz')
...
def main():
    ...
    model_filename = f"{results_dir}/tqfm_moon_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.pkl"
    ...
    kernel_filename = f"{results_dir}/kernels_moon_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.npz"
    np.savez(
        kernel_filename,
