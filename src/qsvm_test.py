...
class QSVC:
    ...
    def __init__(self, C=1.0, gamma=1.0, depth=1, type_ansatz='EfficientSU2', random=False, num_samples=None):
        """
    ...
    def fit(self, X, y, kernel_matrix, theta_optimal, parametrized_circuit, optimizer, initial_xi=None, ansatz=None):
        """
        ...
        fun = lambda x: self._loss_function(x, self.hamiltonian)
        result = self.optimizer.minimize(fun, x0=self.initial_xi)
