...
# Load data
loaded_data = np.load('data/classification_data.npz')
...
def main():
    ...
    results_dir = "results_tqfm_classification"
    ...
    model_filename = f"{results_dir}/tqfm_classification_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.pkl"
    ...
    kernel_filename = f"{results_dir}/kernels_classification_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.npz"
    np.savez(
        kernel_filename,
