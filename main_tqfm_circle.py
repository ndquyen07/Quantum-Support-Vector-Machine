...
# Load data
loaded_data = np.load('data/circle_data.npz')
...
def main():
    ...
    results_dir = "results_tqfm_circle"
    ...
    model_filename = f"{results_dir}/tqfm_circle_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.pkl"
    ...
    kernel_filename = f"{results_dir}/kernels_circle_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.npz"
    np.savez(
        kernel_filename,
