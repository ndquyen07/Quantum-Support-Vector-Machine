...
print("="*70)
print("TQFM Training - Make Gauss")
print("="*70)
...
loaded_data = np.load('data/mgq_4features_data.npz')
...
def main():
    ...
    model_filename = f"{results_dir}/tqfm_mgq_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.pkl"
    ...
    kernel_filename = f"{results_dir}/kernels_mgq_depth{args.depth}_ansatz{args.type_ansatz}_iter{args.maxiter}_run{args.run_id}.npz"
    np.savez(
        kernel_filename,
